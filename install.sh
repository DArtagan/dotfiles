...
files="autoenv autoload bashrc Xresources oh-my-zsh pentadactylrc vimrc vim zshrc config/awesome config/terminator"     # list of files/folders to symlink in homedir seperated by spaces
