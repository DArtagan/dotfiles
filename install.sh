...
files="antigen autoenv autoload bashrc Xresources oh-my-zsh pentadactylrc vimrc vim weechat zshenv zshrc zsh_aliases config/awesome config/terminator config/termite config/uzbl"
