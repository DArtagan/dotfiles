...
files="autoload bashrc Xresources oh-my-zsh vimrc vim zshrc config/awesome config/terminator"     # list of files/folders to symlink in homedir seperated by spaces
